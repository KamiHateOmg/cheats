...
echo.
echo.
echo [93m Welcome, %USERNAME%. Hope you enjoy the cheats.^^^^^[0m
echo.
echo [93m Firstly, pick the option you want to : [0m
echo.
echo [96m 1 - Enter cheat library[0m
echo [96m 2 - Join KamiTool server[0m
echo [96m 3 - Add by.kami on discord[0m
echo [96m 4 - Quit[0m
echo.
